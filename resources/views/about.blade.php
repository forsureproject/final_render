                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <div class="flex flex-col ">
                                <!-- Card -->
                                <div class="group flex w-full h-full  rounded-lg p-5 transition-all dark:hover:bg-white/[.075]" >
                                  ...
                                  <div>
                                    <div>
                                      <div class=" block font-bold text-lime-500 dark:text-lime-500   ">Beauty & Elegance</div>
                                      <p class="text-gray-600 dark:text-gray-400 !my-1">The style of architecture, the way the building is structured inside and outside. We have a standard when it comes to even the demarcations of our lands that when noticed
                                ...
                                <div class="group flex w-full h-full  rounded-lg p-5 transition-all dark:hover:bg-white/[.075]" >
                                  ...
                                  <div>
                                    <div>
                                      <div class=" block font-bold text-lime-500 dark:text-lime-500   ">Strength</div>
                                      <p class="text-gray-600 dark:text-gray-400 !my-1">This is where our professional Building Engineers play their role in making sure from the land to the building of the house is safe. </p>
                                    </div>
                                ...
                                <div class="group flex w-full h-full  rounded-lg p-5 transition-all dark:hover:bg-white/[.075]" >
                                  ...
                                  <div>
                                    <div>
                                      <div class=" block font-bold text-lime-500 dark:text-lime-500   ">Serenity</div>
                                      <p class="text-gray-600 dark:text-gray-400 !my-1">Our properties are situated at a no trouble area and are well secured in other for our clients to always feel at peace.</p>
                                    </div>
