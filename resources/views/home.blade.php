                ...
                <ul>
                    ...
                    <li data-transition='slideleft' data-slotamount='default' data-masterspeed="1000"
                        ...
                        <div class="slider-title tp-caption tp-resizeme" data-x="['left']" data-hoffset="['156']"
                            ...
                            Discover your roots <br>with real estate in <br>Africa.
                            {{-- Own a piece <br>of Africa's<br> promising <br>future. --}}
                        </div>
                        ...
                        <div class="slider-title tp-caption" data-x="['left']" data-hoffset="['156']"
                            ...
                            data-splitin="chars" data-splitout="none" data-responsive_offset="on"
                            data-elementdelay="0.05"
                            style="font-weight:600; letter-spacing:0.1em; text-transform:uppercase; margin-bottom:5rem;">
                    ...
                    <li data-transition='slideleft' data-slotamount='default' data-masterspeed="1000"
                        ...
                        <div class="slider-title tp-caption tp-resizeme" data-x="['left']" data-hoffset="['156']"
                            ...
                            data-elementdelay="0.05"
                            style="font-weight:600; letter-spacing:-0.01em; line-height: 50px; font-size:55px;">
                            Find your dream home <br>in the land of <br>your ancestors.
                        </div>
                    ...
                    <li data-transition='slideleft' data-slotamount='default' data-masterspeed="1000"
                        ...
                        <img src="images/slider/slide4.jpg" data-bgparallax="5" alt=""
                            data-bgposition="center 0" data-bgfit="cover" data-bgrepeat="no-repeat"
                            class="rev-slidebg">
                        ...
                        <div class="slider-title tp-caption tp-resizeme" data-x="['left']" data-hoffset="['156']"
                            ...
                            data-elementdelay="0.05"
                            style="font-weight:600; letter-spacing:-0.01em; line-height: 50px; font-size:55px;">
                            Secure your legacy <br>with real estate in <br>Africa
                        </div>
